...
const PERSONALITIES: Record<string, Personality> = {
  comfort: {
    ...
    description:
      'Когато ти е тежко, отиваш в кухнята. Без грим, без планове, само мусака и одеяло. Никой не те съди — нито аз.',
  ...
  loyal: {
    ...
    description:
      'Намерила си ястието и спираш да търсиш. Защо да рискуваш с друго? Ефикасност, постоянство, спокойствие. Малко скучно, но работи.',
