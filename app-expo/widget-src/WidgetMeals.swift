// AUTO-GENERATED from app-expo/data/meals.json — do not edit by hand.
// Regenerate with scripts/gen-widget-meals.py
...
enum Meals {
    static let all: [WidgetMeal] = [
        WidgetMeal(emoji: "🍲", name: "Супа", moods: [
        ...
        WidgetMeal(emoji: "🥗", name: "Салата", moods: [
        ...
        WidgetMeal(emoji: "🥒", name: "Таратор", moods: [
        ...
        WidgetMeal(emoji: "🥦", name: "Печени зеленчуци", moods: [
        ...
        WidgetMeal(emoji: "🍳", name: "Яйца", moods: [
        ...
        WidgetMeal(emoji: "🛒", name: "Всичко", moods: [
            WidgetMoodOption(badge: "😂 Honest", glow: (0.85, 0.55, 0.15), reasons: ["поръчай 4 неща, изяж 1.5"]),
        ]),
        WidgetMeal(emoji: "🧊", name: "Отваряне на хладилника", moods: [
        ...
        WidgetMeal(emoji: "🍅🍞", name: "Лютеница с хляб", moods: [
        ...
        WidgetMeal(emoji: "🍞🧀", name: "Попара", moods: [
        ...
        WidgetMeal(emoji: "🍗", name: "Скара", moods: [
        ...
        WidgetMeal(emoji: "🍕", name: "Пица от кварталната", moods: [
        ...
        WidgetMeal(emoji: "🌭⛽", name: "Хот дог от бензиностанция", moods: [
        ...
        WidgetMeal(emoji: "🍵", name: "Matcha latte", moods: [
        ...
        WidgetMeal(emoji: "🥣", name: "Овесена каша", moods: [
        ...
        WidgetMeal(emoji: "🥘", name: "Гювеч", moods: [
        ...
        WidgetMeal(emoji: "🍲", name: "Шкембе чорба", moods: [
        ...
        WidgetMeal(emoji: "❄️🍕", name: "Замразена пица", moods: [
        ...
        WidgetMeal(emoji: "🍱", name: "Поке боул", moods: [
        ...
        WidgetMeal(emoji: "🌮", name: "Тако", moods: [
        ...
        WidgetMeal(emoji: "🍜", name: "Истински рамен", moods: [
        ...
        WidgetMeal(emoji: "🍛🌶️", name: "Тайландско къри", moods: [
        ...
        WidgetMeal(emoji: "🌶️", name: "Чушки бюрек", moods: [
        ...
        WidgetMeal(emoji: "🥯", name: "Геврек със сусам", moods: [
        ...
        WidgetMeal(emoji: "🐟", name: "Цаца", moods: [
        ...
        WidgetMeal(emoji: "🥔", name: "Руска салата", moods: [
        ...
        WidgetMeal(emoji: "🍬", name: "Само малко сладко", moods: [
        ...
        WidgetMeal(emoji: "☕🥂", name: "Кафе + мимоза", moods: [
        ...
        WidgetMeal(emoji: "🥐☕", name: "Brunch", moods: [
        ...
        WidgetMeal(emoji: "🍸☀️", name: "Brunch + алкохол", moods: [
        ...
        WidgetMeal(emoji: "🍩", name: "Мекици", moods: [
        ...
        WidgetMeal(emoji: "🧄", name: "Чесън", moods: [
        ...
        WidgetMeal(emoji: "🍌", name: "Банан", moods: [
        ...
        WidgetMeal(emoji: "🥤🌿", name: "Green juice", moods: [
        ...
        WidgetMeal(emoji: "🐟", name: "Сьомга", moods: [
        ...
        WidgetMeal(emoji: "🫛", name: "Едамаме", moods: [
        ...
        WidgetMeal(emoji: "🌾🥛", name: "Овесено мляко", moods: [
        ...
        WidgetMeal(emoji: "🥯🥑", name: "Bagel с авокадо", moods: [
        ...
        WidgetMeal(emoji: "🍠", name: "Чипс от кейл", moods: [
        ...
        WidgetMeal(emoji: "🧈", name: "Гхи", moods: [
        ...
        WidgetMeal(emoji: "🥜", name: "Тахан", moods: [
        ...
        WidgetMeal(emoji: "🥖", name: "Sourdough", moods: [
        ...
        WidgetMeal(emoji: "🍫", name: "Тъмен шоколад 85%", moods: [
        ...
        WidgetMeal(emoji: "💧", name: "Алкална вода", moods: [
        ...
        WidgetMeal(emoji: "🦴", name: "Бульон от кости", moods: [
        ...
        WidgetMeal(emoji: "🥥", name: "Кокосова вода", moods: [
        ...
        WidgetMeal(emoji: "🥚", name: "Яйца от свободно отглеждани кокошки", moods: [
        ...
        WidgetMeal(emoji: "🍫🐪", name: "Dubai шоколад", moods: [
        ...
        WidgetMeal(emoji: "🥪", name: "Сандвич с лютеница и сирене", moods: [
        ...
        WidgetMeal(emoji: "🫙🥒", name: "Кисела краставичка от буркана", moods: [
        ...
        WidgetMeal(emoji: "🍣🛒", name: "Суши от супермаркет", moods: [
        ...
        WidgetMeal(emoji: "🍿", name: "Пуканки в кино", moods: [
            WidgetMoodOption(badge: "😂 Honest", glow: (0.85, 0.55, 0.15), reasons: ["плащаш 11€ за царевица и въздух"]),
        ]),
        WidgetMeal(emoji: "🥐🍳", name: "Закуска от хотелски бюфет", moods: [
        ...
        WidgetMeal(emoji: "🦞", name: "Омар", moods: [
        ...
        WidgetMeal(emoji: "🍤", name: "Скариди на тиган", moods: [
        ...
        WidgetMeal(emoji: "🍝", name: "Спагети болонезе", moods: [
        ...
        WidgetMeal(emoji: "🍛", name: "Пиле с къри", moods: [
        ...
        WidgetMeal(emoji: "🍟", name: "Картофки трюфел и пармезан", moods: [
            WidgetMoodOption(badge: "💅 Fancy", glow: (0.85, 0.45, 0.55), reasons: ["картофки, които са ходили в чужбина"]),
        ]),
        WidgetMeal(emoji: "🥩", name: "Рибай стек", moods: [
        ...
        WidgetMeal(emoji: "🍕", name: "Пица „Хавай\"", moods: [
        ...
        WidgetMeal(emoji: "🍗", name: "Бъфало крилца", moods: [
        ...
        WidgetMeal(emoji: "🥣", name: "Корнфлейкс с мляко", moods: [
        ...
        WidgetMeal(emoji: "🥒", name: "Дзадзики", moods: [
        ...
        WidgetMeal(emoji: "🍳", name: "Менемен", moods: [
        ...
        WidgetMeal(emoji: "🥘", name: "Корейски Bibimbap", moods: [
        ...
        WidgetMeal(emoji: "🍖", name: "Пилешки крилца BBQ", moods: [
        ...
        WidgetMeal(emoji: "🎃🍲", name: "Крем супа от тиква", moods: [
        ...
        WidgetMeal(emoji: "🍗🍍", name: "Китайски Sweet & Sour Chicken", moods: [
            WidgetMoodOption(badge: "😂 Honest", glow: (0.85, 0.55, 0.15), reasons: ["пиле, което е сладко-кисело като живота ти"]),
        ]),
        WidgetMeal(emoji: "🍛", name: "Индийско Butter Chicken", moods: [
        ...
        WidgetMeal(emoji: "🥒", name: "Пържени тиквички с чеснов сос", moods: [
        ...
        WidgetMeal(emoji: "☕", name: "Капучино", moods: [
        ...
        WidgetMeal(emoji: "☕🧊", name: "Фрапе", moods: [
        ...
        WidgetMeal(emoji: "🧊☕", name: "Фредо Капучино", moods: [
        ...
        WidgetMeal(emoji: "🍋🥤", name: "Лимонада", moods: [
        ...
        WidgetMeal(emoji: "🍷", name: "Вино", moods: [
        ...
        WidgetMeal(emoji: "🍸", name: "Gin & Tonic", moods: [
        ...
        WidgetMeal(emoji: "🥃", name: "Текила", moods: [
        ...
        WidgetMeal(emoji: "🫙", name: "Боза", moods: [
        ...
        WidgetMeal(emoji: "🫖", name: "Чай", moods: [
        ...
        WidgetMeal(emoji: "🧋", name: "Bubble Tea", moods: [
        ...
        WidgetMeal(emoji: "🍳", name: "Омлет", moods: [
        ...
        WidgetMeal(emoji: "🥐", name: "Pain au chocolat", moods: [
        ...
        WidgetMeal(emoji: "🥐", name: "Кифла от фурната", moods: [
        ...
        WidgetMeal(emoji: "🍞", name: "Козунак", moods: [
        ...
        WidgetMeal(emoji: "🍞", name: "Погача", moods: [
        ...
        WidgetMeal(emoji: "🥬", name: "Зелник", moods: [
        ...
        WidgetMeal(emoji: "🎃", name: "Тиквеник", moods: [
        ...
        WidgetMeal(emoji: "🥐🥛", name: "Баница с айран", moods: [
